...
Scrolling capture, OCR, video/GIF capture and cloud uploads are **not** part of 0.4.2. Evaluate them only with a separate privacy, performance and product brief. The current release remains local-first; blur is not a substitute for opaque redaction.
